@frozen public struct InlineBuffer<Storage>: Sendable where Storage: Sendable {
...
extension InlineBuffer: RandomAccessCollection, MutableCollection {
    ...
    @inlinable public var endIndex: Int { MemoryLayout<Storage>.size }
...
extension InlineBuffer: ExpressibleByIntegerLiteral {
    @inlinable public init(integerLiteral: __shared StaticBigInt) {
...
extension InlineBuffer: LosslessStringConvertible {
    ...
    @inlinable public init?<String>(
        _ description: __shared String
        ...
        let storage: Storage? = withUnsafeTemporaryAllocation(
            ...
            guard case nil = input.next() else {
                return nil
            }
