...
public protocol MessageAuthenticationHash: RandomAccessCollection<UInt8> where Index == Int {
...
extension MessageAuthenticationHash {
    ...
    @inlinable public init(
        authenticating message: some Sequence<UInt8>,
        key: some Collection<UInt8>
    ) {
...
extension MessageAuthenticationHash {
    ...
    @inlinable public static func pbkdf2(
