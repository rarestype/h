...
@frozen public struct UUID: Sendable {
    ...
    public let bitPattern: (UInt64, UInt64)
    ...
    @inlinable public init(bitPattern: (UInt64, UInt64)) {
    ...
    @inlinable public init(_ high: UInt64, _ low: UInt64) {
...
extension UUID {
    ...
    @inlinable public init<Bytes>(_ bytes: Bytes) where Bytes: Collection,
        Bytes.Element == UInt8 {
...
extension UUID: Equatable {
    @inlinable public static func == (a: Self, b: Self) -> Bool { a.bitPattern == b.bitPattern }
}
